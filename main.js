...
// Function to add event listeners for menu buttons
function addMenuButtonListeners() {
    document.querySelector(".play-normal-btn").addEventListener("click", function() {
        playSound("90s-game-ui-7-185100"); // Menu sound
        // Add logic to start the game
    });

    document.querySelector(".play-casual-btn").addEventListener("click", function() {
        playSound("90s-game-ui-7-185100"); // Menu sound
        // Add logic to start casual mode
    });
...
// Function to add event listener for cutting action
function addCuttingActionListener() {
    document.getElementById("c").addEventListener("mousedown", function() {
        playSound("knife-slice-41231"); // Cut sound
    });
}
});